...
- [E1 v0.76.3 replay 0002 consumed-failure record](../../docs/evidence/e1-stock-go-v0763-replay-0002-consumed-failure-2026-08-09.md)
  - `EV-E1-EMU24-20260809-0002`: second real full-mode run on 2026-08-09 aborted before any platform measurement by a runner defect (`exit 1`; literal `PT_TLS` grep false negative on a real TLS program header); **ID consumed, no same-ID rerun**
- [E1 v0.76.3 replay 0003 measured-blocked record](../../docs/evidence/e1-stock-go-v0763-replay-0003-measured-blocked-2026-08-09.md)
  - `EV-E1-EMU24-20260809-0003`: third real full-mode run on 2026-08-09 completed the full pipeline on the real API 24 x86_64 phone Emulator (non-physical); guest loader precisely rejected stock Go 1.25.12 `libgoprobe.so` at `dlopen` (`res_search: initial-exec TLS resolves to dynamic definition`, `loaderErrno=2`); `MEASURED_VERDICT=blocked`/`VERDICT=blocked`/`RECORD_STATUS=collected` (runner-sealed pre-review state in formal raw, immutable; record-level status after final review `REV-E1-EMU24-20260809-0003` is `reviewed-pass/blocked`); `AA_TEST_RC=0` (host) with guest `TestFinished-ResultCode: 1`; baseline online verify pass; cleanup complete, no residual; E8 stays `CLOSED`; **ID consumed, no same-ID rerun**; two out-of-band supplements (QEMU boot section excerpt, baseline public-API postmortem) cover the re-checkable gaps
- [E1 v0.76.3 replay 0003 final review record](../../docs/evidence/e1-stock-go-v0763-replay-0003-review-2026-08-09.md)
  - `REV-E1-EMU24-20260809-0003`: dual independent final review (`anthropic/claude-opus-5` evidence-integrity + `moonshotai/kimi-k2.7-code` status-consistency) 0 blocker/0 major; main session recomputed 11 material sha256, all matched; `record_status: reviewed-pass`, `verdict: blocked`; `reviewed-pass` is not E1 pass, E1 overall Go not closed, E8 stays `CLOSED`
...
`EV-E1-EMU24-20260809-0001` was consumed by the first real full-mode run on 2026-08-09, which aborted before any measurement due to a runner defect (see the [0001 consumed-failure record](../../docs/evidence/e1-stock-go-v0763-replay-0001-consumed-failure-2026-08-09.md)); `EV-E1-EMU24-20260809-0002` was consumed by the second real full-mode run, which aborted before any platform measurement due to a runner defect (literal `PT_TLS` grep false negative; see the [0002 consumed-failure record](../../docs/evidence/e1-stock-go-v0763-replay-0002-consumed-failure-2026-08-09.md)); `EV-E1-EMU24-20260809-0003` was executed on 2026-08-09 as the third real full-mode run and completed with `MEASURED_VERDICT=blocked`/`RECORD_STATUS=collected` (runner-sealed pre-review state in formal raw; record-level status after final review `REV-E1-EMU24-20260809-0003` is `reviewed-pass/blocked`; measured stock Go 1.25.12 loader rejection on the real API 24 x86_64 phone Emulator; see the [0003 measured-blocked record](../../docs/evidence/e1-stock-go-v0763-replay-0003-measured-blocked-2026-08-09.md) and the [0003 final review record](../../docs/evidence/e1-stock-go-v0763-replay-0003-review-2026-08-09.md)) — **ID consumed, no same-ID rerun**; any further formal run would use a new ID assigned by the main session.

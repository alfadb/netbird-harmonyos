...
-------------------------
The runner is bound to AUTH-E3-PHYS1API26-20260813-0001 (ADJ-20260810-0001,
C6): one AUTH, one fixed candidate pair
(E3-PHYS-PREFLIGHT-20260810-0001 / EV-E3-PHYS1API26-20260810-0001), and
...
AUTH_ID = 'AUTH-E3-PHYS1API26-20260813-0001'
CANDIDATE_CAMPAIGN_ID = 'E3-PHYS-PREFLIGHT-20260810-0001'
CANDIDATE_EVIDENCE_ID = 'EV-E3-PHYS1API26-20260810-0001'
...
def assert_machine_fresh_confirmation(freeze):
    ...
    bound to AUTH-E3-PHYS1API26-20260813-0001 and the fixed candidate pair,

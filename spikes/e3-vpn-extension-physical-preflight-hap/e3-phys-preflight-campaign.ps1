...
$script:AuthId = 'AUTH-E3-PHYS1API26-20260816-0001'
$script:CandidateCampaignId = 'E3-PHYS-PREFLIGHT-20260816-0001'
$script:CandidateEvidenceId = 'EV-E3-PHYS1API26-20260816-0001'
...
function Assert-MachineFreshConfirmation {
    ...
    # object to be status=pass, bound to AUTH-E3-PHYS1API26-20260816-0001 and the fixed candidate
    # pair E3-PHYS-PREFLIGHT-20260816-0001 / EV-E3-PHYS1API26-20260816-0001, with a real

...
$script:AuthId = 'AUTH-E3-PHYS1API26-20260816-0002'
$script:CandidateCampaignId = 'E3-PHYS-PREFLIGHT-20260816-0002'
$script:CandidateEvidenceId = 'EV-E3-PHYS1API26-20260816-0002'
...
function Assert-MachineFreshConfirmation {
    ...
    # object to be status=pass, bound to AUTH-E3-PHYS1API26-20260816-0002 and the fixed candidate
    # pair E3-PHYS-PREFLIGHT-20260816-0002 / EV-E3-PHYS1API26-20260816-0002, with a real

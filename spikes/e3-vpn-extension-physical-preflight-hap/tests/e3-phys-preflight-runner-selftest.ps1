...
try {
    ...
    $confirmBlockedFreeze = New-Freeze 'blocked' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'
    ...
    $confirmWrongPairFreeze = New-Freeze 'blocked' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-WRONG'
    ...
    $confirmRetryFreeze = New-Freeze 'blocked' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'
    ...
    function Write-ConfirmationRecordFixture {
        param([string]$Name, $Freeze, [string]$OverrideAuthId = 'AUTH-E3-PHYS1API26-20260829-0001', [string]$OverrideVerdict = 'pass')
        $record = [ordered]@{
            schema_version = 1
    ...
    function Add-ConfirmationBinding {
        param($Freeze, [string]$RecordPath, [string]$RecordSha256, [string]$Status = 'pass', [string]$AuthId = 'AUTH-E3-PHYS1API26-20260829-0001')
    ...
    $wrongReviewerRoleFreeze = New-Freeze 'blocked' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'
    ...
    $readyNoConfirmFreeze = New-Freeze 'ready' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'
    ...
    Assert-True ([string]$readyBoundRecord.machine_fresh_confirmation.status -eq 'pass' -and [string]$readyBoundRecord.machine_fresh_confirmation.authorization_id -eq 'AUTH-E3-PHYS1API26-20260829-0001' -and [string]$readyBoundRecord.machine_fresh_confirmation.record_sha256 -eq $readyConfirmRecord.Sha256 -and $null -eq $readyBoundRecord.machine_fresh_confirmation.PSObject.Properties['record_path']) 'sealed record machine_fresh_confirmation projection mismatch or leaked path'
    ...
    $blockedPassFreeze = New-Freeze 'blocked' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'
    ...
    $twoPhaseBlockedFreeze = New-Freeze 'blocked' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'
    $twoPhaseBlockedFreeze.preflight_inputs_frozen_at = '2099-01-01T00:00:00+00:00'
    $twoPhaseReadyFreeze = New-Freeze 'ready' 'EV-E3-PHYS1API26-20260829-0001' 'E3-PHYS-PREFLIGHT-20260829-0001'

...
用户于 2026-08-16 本轮明确批准：保留 20260816-0001 为 gate-3 review-blocked，修正 source provenance，并进入 AUTH/pair 20260816-0002 的完整 13 门。0004 S5 与 0005 S6 B 的最小脱敏 production-derived fixture 继续只作 provenance；当前执行常量绑定 `AUTH-E3-PHYS1API26-20260816-0002` 及 pair `E3-PHYS-PREFLIGHT-20260816-0002` / `EV-E3-PHYS1API26-20260816-0002`。0001/0005 均不可回溯或复用。当前 host-only registration 禁止 HDC、设备、TargetBindingConfirm、0002 audits/freezes/records、DryRun、Live、commit 与 push。

...
用户于 2026-08-16 本轮明确批准：保留 20260816-0002 为 `governance-order-invalid-retired` 历史，并进入 AUTH/pair 20260816-0003 的完整 13 门。0004 S5 与 0005 S6 B 的最小脱敏 production-derived fixture 继续只作 provenance；当前执行常量绑定 `AUTH-E3-PHYS1API26-20260816-0003` 及 pair `E3-PHYS-PREFLIGHT-20260816-0003` / `EV-E3-PHYS1API26-20260816-0003`。历史 AUTH/pair 均不可回溯或复用。当前 host-only registration 禁止任何 HDC 可执行文件或子命令、设备、TargetBindingConfirm、0003 audits/freezes/records、DryRun、Live、commit 与 push。

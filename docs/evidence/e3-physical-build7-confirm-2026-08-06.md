...
- 不新增 campaign、不改变 `E3-PHYS-PREFLIGHT-20260806-0002` / `EV-E3-PHYS1API26-20260806-0001` 等既有 ID。
- 当前 `plan_status: ready` 仍只表示新 campaign host 输入 ready；最终 commit-bound freeze 须基于包含本登记的提交重生；设备执行仍须明确再确认。

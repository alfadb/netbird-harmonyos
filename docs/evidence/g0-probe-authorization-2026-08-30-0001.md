...
提交时实现产物 sha256（`spikes/g0-go-arm64-phys-hap/` 下）：runner py `e12f6387…a44f2`、runner ps1 `a3c36e89…3f5d`、selftest py `729b69a8…c558b`、selftest ps1 `bc2f8ff0…2fddb0`、fake-hdc `962d28be…c2d9f`；正式 freeze 于 gate 3/6/8 现场创建时按上述强制重算规则绑定（工作树演进后 hash 随之重算，非静态值）。

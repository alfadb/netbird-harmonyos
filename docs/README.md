...
- [E3-PHYS-PREFLIGHT 物理设备执行授权登记（2026-08-17 · 0002，当前）](evidence/e3-physical-preflight-authorization-2026-08-17-0002.md)
  - `AUTH-E3-PHYS1API26-20260817-0002`：新 pair `E3-PHYS-PREFLIGHT-20260817-0002` / `EV-E3-PHYS1API26-20260817-0002`，attempt initial / retry N/A；当前 `blocked-awaiting-full-gates`、not ready，0002 machine confirmation/review/freeze/DryRun/Live 均 pending；reviewer/source/HAP/S6 逻辑不改，新增设备进程枚举与额外 discovery 永久禁令；E8 `CLOSED`

...
- **当前覆盖（2026-08-15 · 0005）**：[`AUTH-E3-PHYS1API26-20260815-0005`](evidence/e3-physical-preflight-authorization-2026-08-15-0005.md) 已 granted，新 pair `E3-PHYS-PREFLIGHT-20260815-0005` / `EV-E3-PHYS1API26-20260815-0005` 固定 attempt initial / retry N/A；0004 sealed invalid consumed，不得复用。现行 S5 采用 production-derived fixture、唯一可见 `Setting.AppDetail`、distinct A/B、step4 随后确认（如有）、post-force observation-only 与 process-absent + bundle-present 决定性门。后续 commit/push 后按 13 门冻结实际 HEAD；E8 `CLOSED`。

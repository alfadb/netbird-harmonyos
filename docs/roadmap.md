...
- **当前覆盖（2026-08-16 · 0001）**：[`AUTH-E3-PHYS1API26-20260816-0001`](evidence/e3-physical-preflight-authorization-2026-08-16-0001.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260816-0001` / `EV-E3-PHYS1API26-20260816-0001`，attempt initial / retry N/A；当前 `blocked-awaiting-full-gates`、not ready，machine confirmation/review/freeze/DryRun/Live 均 pending。现行 S5 采用唯一可见 `Setting.AppDetail` 路径，S6 采用 A Start1/A optional Allow2/B Start3/B optional Allow4；新 pair 只适用于修复 commit `9c1d464f...` 之后的完整 13 门。0005 sealed blocked consumed，不得复用；E8 `CLOSED`。

...
- **当前覆盖（2026-08-16 · 0003）**：[`AUTH-E3-PHYS1API26-20260816-0003`](evidence/e3-physical-preflight-authorization-2026-08-16-0003.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260816-0003` / `EV-E3-PHYS1API26-20260816-0003`，attempt initial / retry N/A；当前 `blocked-awaiting-full-gates`、not ready，machine confirmation/review/freeze/DryRun/Live 均 pending。现行 S5 采用唯一可见 `Setting.AppDetail` 路径，S6 采用 A Start1/A optional Allow2/B Start3/B optional Allow4；HAP source basis 为 `62409c5f...`，最终 runner/governance `code_sha` 独立冻结。0002 因 gate 1 未完成时 gate 4 操作提前而 `governance-order-invalid-retired`，未 Live、未 consumed；历史 AUTH/pair 均不得复用；E8 `CLOSED`。

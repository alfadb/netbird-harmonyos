...
- **当前覆盖（2026-08-17 · 0002）**：[`AUTH-E3-PHYS1API26-20260817-0002`](evidence/e3-physical-preflight-authorization-2026-08-17-0002.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260817-0002` / `EV-E3-PHYS1API26-20260817-0002`，attempt initial / retry N/A；当前 `blocked-awaiting-full-gates`、not ready，0002 machine confirmation/review/freeze/DryRun/Live 均 pending。S5/S6、reviewer、source/HAP 逻辑不改；0001 已在 gate 9 因未授权设备进程枚举以 `governance-operation-invalid-retired` 退役，audit-2 文件不构成 gate pass，gate 10-13 未运行，未 DryRun/Live、未 consumed。历史 AUTH/pair 均不得复用；E8 `CLOSED`。

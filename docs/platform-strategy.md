...
**当前覆盖（2026-08-17 · 0001）**：[`AUTH-E3-PHYS1API26-20260817-0001`](evidence/e3-physical-preflight-authorization-2026-08-17-0001.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260817-0001` / `EV-E3-PHYS1API26-20260817-0001`，attempt initial / retry N/A；当前 `blocked-awaiting-full-gates`、not ready，machine confirmation/review/freeze/DryRun/Live 均 pending，reviewer role exact 为 `isolated-anthropic-claude-opus-5-reviewer`。HAP source basis 固定为 `62409c5f...`，最终 runner/governance `code_sha` 在 gate 1 独立确定。0003 已在 gate 7 因 role mismatch 退役，未 Live、未 consumed；历史 AUTH/pair 均不得复用。E3 未关闭，E8 `CLOSED`。

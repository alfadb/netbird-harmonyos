...
**当前覆盖（2026-08-16 · 0002）**：[`AUTH-E3-PHYS1API26-20260816-0002`](evidence/e3-physical-preflight-authorization-2026-08-16-0002.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260816-0002` / `EV-E3-PHYS1API26-20260816-0002`，attempt initial / retry N/A；当前 `blocked-awaiting-full-gates`、not ready，machine confirmation/review/freeze/DryRun/Live 均 pending。HAP source basis 固定为 `62409c5f...`，最终 runner/governance `code_sha` 在 gate 1 独立确定。0001 已 gate-3 review-blocked retired，0005 已 sealed blocked consumed，均不得复用。E3 未关闭，E8 `CLOSED`。

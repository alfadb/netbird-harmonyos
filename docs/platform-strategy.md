...
**当前覆盖（2026-08-15 · 0005）**：[`AUTH-E3-PHYS1API26-20260815-0005`](evidence/e3-physical-preflight-authorization-2026-08-15-0005.md) 已 granted，新 pair `E3-PHYS-PREFLIGHT-20260815-0005` / `EV-E3-PHYS1API26-20260815-0005` 固定 attempt initial / retry N/A；0004 sealed invalid consumed，不得复用。现行 S5 production-layout 修复与后续 13 门以该登记为准；commit/push 后 freeze 绑定实际 HEAD。E3 未关闭，E8 `CLOSED`。

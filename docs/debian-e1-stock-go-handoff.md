...
| E3-PHYS-PREFLIGHT | **当前（2026-08-15 · 0005）**：[`AUTH-E3-PHYS1API26-20260815-0005`](evidence/e3-physical-preflight-authorization-2026-08-15-0005.md) 已 granted；新 pair `E3-PHYS-PREFLIGHT-20260815-0005` / `EV-E3-PHYS1API26-20260815-0005`，attempt initial / retry N/A，`plan_status: authorized-awaiting-linux-ready-freeze`；0004 sealed invalid consumed，不得复用；后续 commit/push 后按 13 门冻结实际 HEAD。2026-08-10 0002 及更早状态均为历史；E8 `CLOSED`（见 [计划](e3-physical-preflight.md)） |

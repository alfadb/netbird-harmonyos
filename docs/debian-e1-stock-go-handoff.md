...
| E3-PHYS-PREFLIGHT | **当前（2026-08-17 · 0002）**：[`AUTH-E3-PHYS1API26-20260817-0002`](evidence/e3-physical-preflight-authorization-2026-08-17-0002.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260817-0002` / `EV-E3-PHYS1API26-20260817-0002`，attempt initial / retry N/A；`plan_status: blocked-awaiting-full-gates`、not ready，reviewer role exact、HAP source basis `62409c5f...` 与最终 `code_sha` 逻辑不变；0001 因 gate 9 未授权设备进程枚举 `governance-operation-invalid-retired`，audit-2 文件不构成 gate pass，未 DryRun/Live/consumed。历史 pair 均不得复用。E8 `CLOSED`（见 [计划](e3-physical-preflight.md)） |

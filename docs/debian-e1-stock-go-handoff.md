...
| E3-PHYS-PREFLIGHT | **当前（2026-08-16 · 0003）**：[`AUTH-E3-PHYS1API26-20260816-0003`](evidence/e3-physical-preflight-authorization-2026-08-16-0003.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260816-0003` / `EV-E3-PHYS1API26-20260816-0003`，attempt initial / retry N/A；`plan_status: blocked-awaiting-full-gates`、not ready，HAP source basis 为 `62409c5f...` 且最终 runner/governance `code_sha` 独立冻结；0002 `governance-order-invalid-retired`、未 Live/未 consumed，历史 pair 均不得复用。更早状态均为历史；E8 `CLOSED`（见 [计划](e3-physical-preflight.md)） |

...
| E3-PHYS-PREFLIGHT | **当前（2026-08-16 · 0002）**：[`AUTH-E3-PHYS1API26-20260816-0002`](evidence/e3-physical-preflight-authorization-2026-08-16-0002.md) 绑定新 pair `E3-PHYS-PREFLIGHT-20260816-0002` / `EV-E3-PHYS1API26-20260816-0002`，attempt initial / retry N/A；`plan_status: blocked-awaiting-full-gates`、not ready，HAP source basis 为 `62409c5f...` 且最终 runner/governance `code_sha` 独立冻结；0001 gate-3 review-blocked retired，0005 sealed blocked consumed，均不得复用。更早状态均为历史；E8 `CLOSED`（见 [计划](e3-physical-preflight.md)） |

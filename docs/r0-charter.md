...
- [ ] 仅按 `E3-PHYS-PREFLIGHT` 在该具名设备执行一个 campaign 并取得 `reviewed-pass/pass`（历史 `E3-PHYS-PREFLIGHT-20260807-0002` / `EV-E3-PHYS1API26-20260807-0002` 为 `consumed-blocked`/`reviewed-pass/blocked`；历史 `E3-PHYS-PREFLIGHT-20260807-0001` 为 `consumed-blocked`；历史准备 `E3-PHYS-PREFLIGHT-20260806-0002` 为 `superseded-unexecuted`）；其他结果保持 E8 `CLOSED`；当前 `blocked-awaiting-device-authorization`（`ADJ-20260807-0003` runner 变更完成，host 侧已重建并登记 [`EV-E3-PHYS1HOST-20260808-0001`](evidence/e3-physical-preflight-host-remediation-2026-08-08.md)；candidate `E3-PHYS-PREFLIGHT-20260808-0001` / `EV-E3-PHYS1API26-20260808-0001` 已准备、freeze `plan_status: blocked`；用户显式设备授权 + fresh device confirmation 完成前无 auto retry/新 ID 授权）。

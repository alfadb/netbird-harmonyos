...
源码/SDK/final HAP hash、清理基线、受控采集根、独立 review 角色、campaign ID、固定 60 秒窗口和 Settings 预测路径曾冻结并使计划进入 `ready`。API23 live model 匹配 `PLA-AL10`，live build 脱敏投影的可见 suffix 与冻结 build 不同，initial 与原 campaign/evidence ID 已消费。rebind、`ADJ-20260806-0003`、host reverify、`ADJ-20260806-0004` build 确认、`ADJ-20260807-0001` 跨日重新编号与 API26 live `consumed-blocked` 后：新元组已冻结，当前准备 campaign/evidence ID 为 `E3-PHYS-PREFLIGHT-20260807-0002` / `EV-E3-PHYS1API26-20260807-0002`（prior blocked `E3-PHYS-PREFLIGHT-20260807-0001` / `EV-E3-PHYS1API26-20260807-0001` 为 `consumed-blocked`，禁局部 scenario5 重放；历史准备 `E3-PHYS-PREFLIGHT-20260806-0002` / `EV-E3-PHYS1API26-20260806-0001` 标 `superseded-unexecuted`），原 FINAL HAP hashes 复用 reverify PASS（public manifest `66a70a52c92b927d4b23e528ae6eaf1b52169e504291c6ff0e7efa4c7ffee010`；HAP/signature/profile/member hashes 未变；不主张安装兼容性），HDC build 已由 `EV-E3-PHYS1BUILD7-20260806-0001` 实测确认逐字匹配（仅 build-confirm；API `26` 仍 rebind 实测）；runner 中文可用性修正待 commit/freeze；当前计划为 `pending-commit-freeze`（需新 commit/freeze/dryrun/device-ready；本登记禁 HDC），E8 `CLOSED`。当前证据见 [API23 物理预检记录](evidence/e3-physical-preflight-2026-08-06.md)、[API26 blocked 记录](evidence/e3-physical-preflight-api26-2026-08-07.md)、[rebind 记录](evidence/e3-physical-rebind7-2026-08-06.md) 与 [build 确认记录](evidence/e3-physical-build7-confirm-2026-08-06.md)。

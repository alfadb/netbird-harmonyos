...
- **当前授权覆盖（2026-08-17 · 0001）**：见 [`AUTH-E3-PHYS1API26-20260817-0001`](evidence/e3-physical-preflight-authorization-2026-08-17-0001.md)；新 pair `E3-PHYS-PREFLIGHT-20260817-0001` / `EV-E3-PHYS1API26-20260817-0001` 固定 attempt initial / retry N/A，当前 `blocked-awaiting-full-gates`、not ready，reviewer role exact 为 `isolated-anthropic-claude-opus-5-reviewer`；HAP source basis 为 `62409c5f...`，最终 runner/governance `code_sha` 另行冻结。0003 已 `governance-review-blocked-retired`，未 Live、未 consumed；历史 AUTH/pair 均不得复用；E8 `CLOSED`。本交接下方设备与历史输入说明不因此改写。

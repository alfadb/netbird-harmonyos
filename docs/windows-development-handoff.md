...
- **当前授权覆盖（2026-08-25 · 0001）**：见 [`AUTH-E3-PHYS1API26-20260825-0001`](evidence/e3-physical-preflight-authorization-2026-08-25-0001.md)；新 pair `E3-PHYS-PREFLIGHT-20260825-0001` / `EV-E3-PHYS1API26-20260825-0001` 固定 attempt initial / retry N/A，当前 `blocked-awaiting-full-gates`、not ready，reviewer/source/HAP 逻辑不变。0002 已因 gate 4（用户 host-prep）未完成时提前执行 gate 5 TargetBindingConfirm 产生 blocked confirmation record 以 `governance-order-invalid-retired` 退役，未 DryRun/Live、未 consumed；0001 已因 gate 9 未授权设备进程枚举 `governance-operation-invalid-retired`，audit-2 文件不构成 gate pass，未 DryRun/Live、未 consumed；历史 AUTH/pair 均不得复用；E8 `CLOSED`。本交接下方设备与历史输入说明不因此改写。

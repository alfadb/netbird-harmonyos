...
- **当前授权覆盖（2026-08-17 · 0002）**：见 [`AUTH-E3-PHYS1API26-20260817-0002`](evidence/e3-physical-preflight-authorization-2026-08-17-0002.md)；新 pair `E3-PHYS-PREFLIGHT-20260817-0002` / `EV-E3-PHYS1API26-20260817-0002` 固定 attempt initial / retry N/A，当前 `blocked-awaiting-full-gates`、not ready，reviewer/source/HAP 逻辑不变。0001 已因 gate 9 未授权设备进程枚举 `governance-operation-invalid-retired`，audit-2 文件不构成 gate pass，未 DryRun/Live、未 consumed；历史 AUTH/pair 均不得复用；E8 `CLOSED`。本交接下方设备与历史输入说明不因此改写。

...
- **当前授权覆盖（2026-08-16 · 0002）**：见 [`AUTH-E3-PHYS1API26-20260816-0002`](evidence/e3-physical-preflight-authorization-2026-08-16-0002.md)；新 pair `E3-PHYS-PREFLIGHT-20260816-0002` / `EV-E3-PHYS1API26-20260816-0002` 固定 attempt initial / retry N/A，当前 `blocked-awaiting-full-gates`、not ready；HAP source basis 为 `62409c5f...`，最终 runner/governance `code_sha` 另行冻结。0001 已 gate-3 review-blocked retired，0005 已 sealed blocked consumed，均不得复用；E8 `CLOSED`。本交接下方设备与历史输入说明不因此改写。

...
- **当前授权覆盖（2026-08-16 · 0001）**：见 [`AUTH-E3-PHYS1API26-20260816-0001`](evidence/e3-physical-preflight-authorization-2026-08-16-0001.md)；新 pair `E3-PHYS-PREFLIGHT-20260816-0001` / `EV-E3-PHYS1API26-20260816-0001` 固定 attempt initial / retry N/A，当前 `blocked-awaiting-full-gates`、not ready，只适用于修复 commit `9c1d464f...` 之后的完整 13 门；0005 sealed blocked consumed，不得复用；E8 `CLOSED`。本交接下方设备与历史输入说明不因此改写。

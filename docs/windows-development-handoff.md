...
- **当前授权覆盖（2026-08-15 · 0005）**：见 [`AUTH-E3-PHYS1API26-20260815-0005`](evidence/e3-physical-preflight-authorization-2026-08-15-0005.md)；新 pair 固定 attempt initial / retry N/A，0004 sealed invalid consumed，不得复用，commit/push 后按 13 门冻结实际 HEAD；E8 `CLOSED`。本交接下方设备与历史输入说明不因此改写。

...
> **当前 E3-PHYS-PREFLIGHT 治理（2026-08-17 · 0002）**：[`AUTH-E3-PHYS1API26-20260817-0002`](docs/evidence/e3-physical-preflight-authorization-2026-08-17-0002.md) 绑定全新 initial pair `E3-PHYS-PREFLIGHT-20260817-0002` / `EV-E3-PHYS1API26-20260817-0002`，当前 `blocked-awaiting-full-gates`、not ready，reviewer role 固定为 `isolated-anthropic-claude-opus-5-reviewer`。0001 已因 gate 9 未授权设备进程枚举而 `governance-operation-invalid-retired`，audit-2 文件不构成有效 gate pass，未 DryRun/Live、未 consumed、不得复用；除 gate 4 exact host-prep 与 runner 22 项白名单外，禁止任何设备命令或额外 discovery。本文其余旧“当前/下一步”叙述均按历史快照理解。

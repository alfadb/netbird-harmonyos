...
> **当前 E3-PHYS-PREFLIGHT 治理（2026-08-16 · 0003）**：[`AUTH-E3-PHYS1API26-20260816-0003`](docs/evidence/e3-physical-preflight-authorization-2026-08-16-0003.md) 绑定全新 initial pair `E3-PHYS-PREFLIGHT-20260816-0003` / `EV-E3-PHYS1API26-20260816-0003`，当前 `blocked-awaiting-full-gates`、not ready。0002 已 `governance-order-invalid-retired`，未 Live、未 consumed，不是设备证据且不得复用。gate 1 绝不可调用 HDC；gate 4 才允许各一次受控 `tconn` 与内存级 `list targets`。本文其余旧“当前/下一步”叙述均按历史快照理解。
